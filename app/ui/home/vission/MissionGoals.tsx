            ...
            <div className="relative h-full bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-xl rounded-2xl p-8 border border-white/20 hover:border-white/40 transition-all duration-500 shadow-xl hover:shadow-2xl overflow-hidden">
              ...
              {goal.metric && (
                <motion.div
                  ...
                  viewport={{ once: true }}
                  className="absolute top-6  bg-gradient-to-r from-blue-500/20 to-purple-500/20 backdrop-blur-sm border border-white/20 rounded-full px-4 py-2"
                >
              ...
              <motion.div
                ...
                viewport={{ once: true }}
                className="relative z-10 w-full h-1 bg-gradient-to-r from-blue-400 to-purple-400 rounded-full origin-left"
              />
