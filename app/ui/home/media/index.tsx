...
export const MediaSpeechesSection: React.FC<MediaSpeechesSectionProps> = ({
  ...
  return (
    <section 
      ref={containerRef}
      className="relative py-32 bg-gradient-to-br from-gray-900 via-slate-800 to-gray-900 overflow-hidden"
    >
      ...
      >
        <div className="absolute top-0 left-0 w-96 h-96 bg-gradient-to-br from-blue-500 to-purple-500 rounded-full mix-blend-multiply filter blur-3xl" />
        <div className="absolute bottom-0 right-0 w-96 h-96 bg-gradient-to-tl from-purple-500 to-indigo-500 rounded-full mix-blend-multiply filter blur-3xl" />
