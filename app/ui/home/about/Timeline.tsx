    ...
    <div className="mb-20">
      ...
      >
        ...
        <p className="text-lg text-gray-600 max-w-2xl mx-auto">
          Key milestones that have shaped our leader&apos;s remarkable career in education and leadership
        </p>
      </motion.div>
              ...
              <div className={`w-full md:w-5/12 ${index % 2 === 0 ? 'md:pr-8' : 'md:pl-8'}`}>
                <div className="bg-white rounded-2xl p-6 shadow-lg border border-gray-100 hover:shadow-xl transition-shadow duration-300">
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <span className={`px-3 py-1 rounded-full text-xs font-medium border ${categoryStyles[milestone.category]}`}>
                      {categoryIcons[milestone.category]} {milestone.category.toUpperCase()}
                    </span>
                  </div>
