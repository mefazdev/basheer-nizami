    ...
    >
      <div className="bg-white rounded-3xl shadow-2xl overflow-hidden border border-gray-100">
        <div className="grid lg:grid-cols-2 gap-0">
          {/* Book Cover */}
          <div className="relative p-12 bg-gradient-to-br from-blue-50 to-purple-50 flex items-center justify-center">
            <motion.div
            ...
            >
              ...
              {/* Featured Badge */}
              <div className="absolute -top-4 -right-4 bg-gradient-to-r from-red-600 to-black text-white px-4 py-2 rounded-full text-sm font-bold shadow-lg">
                Featured
              </div>
