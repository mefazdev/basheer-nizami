            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              >
                <motion.div
                  ...
                  className="text-sm font-medium text-blue-300 uppercase tracking-wider"
                >
                  Latest News
                </motion.div>
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                  className="inline-flex items-center px-8 py-3 bg-white hover:bg-white/60 text-gray-800  font-semibold rounded-lg transition-colors"
                >
                  Read Full Article
                </motion.button>
              </motion.div>
