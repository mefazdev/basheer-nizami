...
//   imageUrl: string;
//   thumbnailUrl?: string;
//   category: 'events' | 'campus-visits' | 'awards' | 'field-visits' | 'speaking' | 'community' | 'conferences' | 'meetings';
//   date: string;
//   location: string;
//   event?: string;
//   tags: string[];
        ...
        >
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className="px-8 py-4 bg-gradient-to-r from-red-600 to-black text-white font-bold rounded-full hover:from-blue-700 hover:to-purple-700 transition-all duration-300 shadow-xl"
            >
              View Full Archive
            </motion.button>
            {/* <motion.button
