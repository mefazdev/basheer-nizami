              ...
              <div className="bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden border border-gray-100 h-full flex flex-col">
                ...
                <div className="p-6 flex-1 flex flex-col">
                  ...
                  <motion.button
                    ...
                    whileTap={{ scale: 0.95 }}
                    className="w-full bg-gradient-to-r from-red-600 to-gray-900 text-white font-semibold py-3 rounded-lg hover:from-red-700 hover:to-gray-700 transition-all duration-300 flex items-center justify-center group"
                  >
                    Read More
                    <motion.svg
